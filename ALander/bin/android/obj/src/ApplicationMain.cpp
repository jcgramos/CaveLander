...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::flash::Lib_obj::setPackage(HX_CSTRING("Yo"),HX_CSTRING("ALander"),HX_CSTRING("tk.opdf.ALander"),HX_CSTRING("1.0.0"));
		HX_STACK_LINE(94)
		...
		HX_STACK_LINE(33)
		::flash::Lib_obj::create( Dynamic(new _Function_1_1()),(int)0,(int)0,(int)100,(int)0,(int((int((int((int((int((int((int((int((int((int(::flash::Lib_obj::HARDWARE) | int(_g))) | int(_g1))) | int(_g2))) | int(_g3))) | int(_g4))) | int(_g5))) | int(_g6))) | int(_g7))) | int(_g8))) | int(_g9)),HX_CSTRING("ALander"),null(),null());
	}
return null();
}
